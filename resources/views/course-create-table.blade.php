...
<div class="br-pagebody pd-x-20 pd-sm-x-30 mg-b-30" id="user_list">
    @include('course-create-table-list')
</div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="dropdown hidden-xs-down">
                                ...
                                <a href="/course/create/add/{{ $user->id }}" id="add{{ $user->id }}" class="btn btn-info btn-icon btn-add" {{ !isset($added_users[$user->id]) ? "":"hidden" }}>
                                    <div><i class="fa fa-plus"></i></div>
                                </a>
                                <a href="/course/create/remove/{{ $user->id }}" id="sub{{ $user->id }}" class="btn btn-danger btn-sub" {{ !isset($added_users[$user->id]) ? "hidden":"" }}>
