...
<ul class="nav nav-tabs sidebar-tabs" role="tablist">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane pos-absolute a-0 mg-t-60 overflow-y-auto active" id="contacts" role="tabpanel">
            ...
            <div class="contact-list pd-x-10">
                ...
                <div class="d-flex">
                    ...
                    <p class="mg-b-0">Somebody</p>
                    <span class="tx-12 op-5 d-inline-block">City, State</span>
                    </div>
        ...
        <div class="pd-x-25">
            <div class="list-group sidebar-event-list mg-b-20">
                ...
                <div class="list-group-item">
                    <div>
                    <h6 class="tx-white tx-13 mg-b-5 tx-normal">CS 145 - QUIZ</h6>
                ...
                <div class="list-group-item">
                    <div>
                    <h6 class="tx-white tx-13 mg-b-5 tx-normal">CS 192 - PROJECT</h6>
        ...
        <div class="pd-y-20 pd-x-25 tx-white">
            ...
            <div class="pos-relative">
            <input type="email" name="email" class="form-control form-control-inverse transition pd-y-10" value="redelosreyes3@up.edu.ph">
            </div>
        </div>
        ...
        <div class="pd-y-20 pd-x-25">
            ...
            <a href="" class="btn btn-block btn-outline-secondary tx-uppercase tx-11 tx-spacing-2">Other Settings</a>
        </div>
