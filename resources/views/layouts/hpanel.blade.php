                    ...
                    <div class="media-list">
                        ...
                        <a href="" class="media-list-link read">
                            <div class="media pd-x-20 pd-y-15">
                                <img src="http://via.placeholder.com/280x280" class="wd-40 rounded-circle" alt="">
                                <div class="media-body">
                                    <p class="tx-13 mg-b-0 tx-gray-700"><strong class="tx-medium tx-gray-800">CS 145
                                            QUIZ 3</strong> added to test list </p>
                            ...
                            <div class="media pd-x-20 pd-y-15">
                                ...
                                <div class="media-body">
                                    <p class="tx-13 mg-b-0 tx-gray-700"><strong
                                            class="tx-medium tx-gray-800">WMTAN</strong> appreciated your work <strong
                                            class="tx-medium tx-gray-800">CS 145 QUIZ 2</strong></p>
                                    <span class="tx-12">November 24, 2021 12:00am</span>
                                </div>
                            </div><!-- media -->
                        </a>
