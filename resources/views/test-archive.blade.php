...
<body class="collapsed-menu with-subleft">
    ...
    <div class="br-contentpanel">
        ...
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
            <h4 class="tx-gray-800 mg-b-5">Available Tests</h4>
            <p class="mg-b-0">These are the test you can answer under your courses</p>
        </div>
                ...
                <table class="table mg-b-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="hidden-xs-down"> {{ $test->id }} </td>
                            <td>
                                ...
                                <span class="pd-l-5"> {{ $test->title }} </span>
                            </td>
                            ...
                            <td class="hidden-xs-down"> {{ $test->course->title }} </td>
                            <td class="dropdown">
                                <a href="/test/{{ $test->id }}/take" class="btn pd-y-3 tx-gray-500 hover-info"><i class="fa fa-pencil"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
