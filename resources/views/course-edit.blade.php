        ...
        <div class="br-pagebody">
            ...
            <form action="/course/{{ $course->id }}" method="post" data-parsley-validate>
                ...
                <div class="br-section-wrapper">
                    ...
                    <!-- HANDLERS -->
                    @php $handlers = '' @endphp
                    @foreach($course->handlers as $user)
                                        ...
                                        <tr>
                                            ...
                                            <td class="dropdown hidden-xs-down">
                                                @if($course->users->contains($user->id))
                                                    <a href="/course/{{ $course->id }}/edit/remove/{{ $user->id }}" class="btn btn-danger btn-icon">
                                                        <div><i class="fa fa-minus"></i></div>
                                                    </a>
                                                @else
                                                    <a href="/course/{{ $course->id }}/edit/add/{{ $user->id }}" class="btn btn-info btn-icon">
